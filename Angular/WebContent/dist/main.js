...
var HeroService = /** @class */ (function () {
    ...
    HeroService.prototype.loginHero = function (userobj, url) {
        console.log(url);
        console.log(window.location.host);
        this.http.post(window.location.host + '/' + '/Angular/Login', {
            name: userobj.name,
...
module.exports = "<h1>login page</h1>\n\n<form >\n  <input type=\"email\" name=\"name\" id=\"\" placeholder=\" enter email\" [(ngModel)]=\"user.name\">\n  <br>\n  <input type=\"text\" name=\"password\" placeholder=\"password\" [(ngModel)]=\"user.password\" > \n  <br>\n  <input type=\"button\" name=\"login\"  value=\"login\" placeholder=\"login\" (click)=\"login()\">\n</form>"
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(router, heroService) {
        this.router = router;
        this.heroService = heroService;
        this.user = {
            name: '',
    ...
    LoginComponent.prototype.login = function () {
        this.heroService.loginHero(this.user, this.router.url);
...
module.exports = __webpack_require__(/*! C:\Users\SYSTEMS\Downloads\toh-pt6\src\main.ts */"./src/main.ts");
